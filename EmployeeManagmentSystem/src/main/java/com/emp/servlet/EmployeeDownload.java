...
public class EmployeeDownload extends HttpServlet {
	private static final String Get_RESUME_PATH_BY_NO = "SELECT RESUME_PATH FROM EMPLOYEETABLE WHERE EMP_ID=?";
	private static final String Get_PHOTO_PATH_BY_NO = "SELECT PHOTO_PATH FROM	EMPLOYEETABLE WHERE EMP_ID=?";
